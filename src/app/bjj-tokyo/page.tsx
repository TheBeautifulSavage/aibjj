...
export const metadata: Metadata = {
  title: "BJJ in Tokyo, JP — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Tokyo, JP. Compare ratings, read reviews, and start training BJJ today. Complete directory of Tokyo BJJ schools.",
  keywords: ["bjj tokyo", "brazilian jiu jitsu tokyo", "bjj classes tokyo", "bjj academies tokyo", "jiu jitsu tokyo"],
  openGraph: {
    title: "BJJ in Tokyo, JP — Best Academies & Classes",
    description: "Find the best BJJ academies in Tokyo, JP. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-tokyo",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-tokyo",
  },
};

export default async function BJJTokyoPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Tokyo",
    description: "Brazilian jiu-jitsu schools and academies in Tokyo, JP",
    url: "https://aibjj.com/bjj-tokyo",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Tokyo, JP</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Tokyo, JP.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Tokyo. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Tokyo</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Tokyo, JP.
