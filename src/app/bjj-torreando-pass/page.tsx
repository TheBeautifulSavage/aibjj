...
export const metadata: Metadata = {
  title: "Torreando Pass: Bullfighter Guard Pass | AIBJJ",
  description: "The torreando (bullfighter) pass controls the ankles and runs around the guard quickly.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Torreando Pass: Bullfighter Guard Pass",
