...
export const metadata: Metadata = {
  title: "Mount Escapes: Bridge and Elbow-Knee | AIBJJ",
  description: "Escaping mount uses the bridge-and-roll and elbow-knee as primary methods.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Mount Escapes: Bridge and Elbow-Knee",
