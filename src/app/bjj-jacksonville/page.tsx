...
export const metadata: Metadata = {
  title: "BJJ in Jacksonville — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Jacksonville, FL. Compare ratings, read reviews, and start training BJJ today. Complete directory of Jacksonville BJJ schools.",
  keywords: ["bjj jacksonville", "brazilian jiu jitsu jacksonville", "bjj classes jacksonville", "bjj academies jacksonville", "jiu jitsu jacksonville"],
  openGraph: {
    title: "BJJ in Jacksonville — Best Academies & Classes",
    description: "Find the best BJJ academies in Jacksonville, FL. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-jacksonville",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-jacksonville",
  },
};

export default async function BJJJacksonvillePage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Jacksonville",
    description: "Brazilian jiu-jitsu schools and academies in Jacksonville, FL",
    url: "https://aibjj.com/bjj-jacksonville",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Jacksonville", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Jacksonville</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Jacksonville, FL.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Jacksonville. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Jacksonville</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Jacksonville, FL.
