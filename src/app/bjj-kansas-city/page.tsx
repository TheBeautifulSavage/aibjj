...
export const metadata: Metadata = {
  title: "BJJ in Kansas City — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Kansas City, MO. Compare ratings, read reviews, and start training BJJ today. Complete directory of Kansas City BJJ schools.",
  keywords: ["bjj kansas city", "brazilian jiu jitsu kansas city", "bjj classes kansas city", "bjj academies kansas city", "jiu jitsu kansas city"],
  openGraph: {
    title: "BJJ in Kansas City — Best Academies & Classes",
    description: "Find the best BJJ academies in Kansas City, MO. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-kansas-city",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-kansas-city",
  },
};

export default async function BJJKansasCityPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Kansas City",
    description: "Brazilian jiu-jitsu schools and academies in Kansas City, MO",
    url: "https://aibjj.com/bjj-kansas-city",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Kansas City", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Kansas City</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Kansas City, MO.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Kansas City. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Kansas City</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Kansas City, MO.
