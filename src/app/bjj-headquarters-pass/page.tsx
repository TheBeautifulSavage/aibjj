...
export const metadata: Metadata = {
  title: "Headquarters Position: Guard Passing Hub | AIBJJ",
  description: "Headquarters is the central no-gi passing position — knee up, hip blocked, patient.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Headquarters Position: Guard Passing Hub",
