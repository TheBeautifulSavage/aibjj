...
export const metadata: Metadata = {
  title: "BJJ Etiquette: Dojo Rules and Respect | AIBJJ",
  description: "BJJ has unwritten rules about hygiene, behavior, and respect on the mats.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "BJJ Etiquette: Dojo Rules and Respect",
