...
export const metadata: Metadata = {
  title: "BJJ in Tucson — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Tucson, AZ. Compare ratings, read reviews, and start training BJJ today. Complete directory of Tucson BJJ schools.",
  keywords: ["bjj tucson", "brazilian jiu jitsu tucson", "bjj classes tucson", "bjj academies tucson", "jiu jitsu tucson"],
  openGraph: {
    title: "BJJ in Tucson — Best Academies & Classes",
    description: "Find the best BJJ academies in Tucson, AZ. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-tucson",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-tucson",
  },
};

export default async function BJJTucsonPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Tucson",
    description: "Brazilian jiu-jitsu schools and academies in Tucson, AZ",
    url: "https://aibjj.com/bjj-tucson",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Tucson", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Tucson</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Tucson, AZ.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Tucson. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Tucson</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Tucson, AZ.
