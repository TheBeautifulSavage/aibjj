...
export const metadata: Metadata = {
  title: "BJJ Guillotine from Standing | AIBJJ",
  description: "How to set up and finish the guillotine from standing in BJJ. Step-by-step breakdown with key details and drilling tips.",
};
...
<article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <h1 className="text-4xl font-black sm:text-5xl">BJJ Guillotine from Standing</h1>
        <p className="mt-4 text-xl text-zinc-400">How to set up and finish the guillotine from standing in BJJ. Step-by-step breakdown with key details and drilling tips.</p>

        <div className="mt-10 space-y-10 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Setting Up from Standing</h2>
            <p>The guillotine from standing begins with establishing control of the position and identifying the openings that allow entry. Grips, body position, and timing are critical. The setup must be smooth enough that your opponent does not recognize the entry until it is too late to defend effectively. Drill the entry sequence separately before combining it with the finish — muscle memory for the setup is what makes this technique work under pressure.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Key Details and Mechanics</h2>
            <p>The most common error when attempting the guillotine from standing is rushing the finish before the position is fully controlled. Alignment and angle directly affect mechanical advantage. Address your opponent's likely defenses before they materialize — have a follow-up ready. The small details that differentiate a finished guillotine from one that gets defended are usually found in hip position, grip location, and the timing of the finishing pressure.</p>
          </section>
          <section>
