...
export const metadata: Metadata = {
  title: "Leg Lock Defense: Protecting Your Knees | AIBJJ",
  description: "Defending leg locks requires understanding the danger and escaping early.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Leg Lock Defense: Protecting Your Knees",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Leg Lock Defense: Protecting Your Knees</h1>
        <p className="mt-4 text-xl text-zinc-400">Defending leg locks requires understanding the danger and escaping early.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding leg lock defense: protecting your knees starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
