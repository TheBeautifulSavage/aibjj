...
export const metadata: Metadata = {
  title: "50/50 Guard Strategy: Leg Lock Position | AIBJJ",
  description: "The 50/50 guard is a neutral leg entanglement — strategy is everything here.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "50/50 Guard Strategy: Leg Lock Position",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">50/50 Guard Strategy: Leg Lock Position</h1>
        <p className="mt-4 text-xl text-zinc-400">The 50/50 guard is a neutral leg entanglement — strategy is everything here.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding 50/50 guard strategy: leg lock position starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
