...
export const metadata: Metadata = {
  title: "Lasso Guard: Arm Control System | AIBJJ",
  description: "Lasso guard wraps the arm to create strong control against passing attempts.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Lasso Guard: Arm Control System",
