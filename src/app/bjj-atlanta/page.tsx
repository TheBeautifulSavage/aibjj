...
export const metadata: Metadata = {
  title: "BJJ in Atlanta — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Atlanta, GA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Atlanta BJJ schools.",
  keywords: ["bjj atlanta", "brazilian jiu jitsu atlanta", "bjj classes atlanta", "bjj academies atlanta", "jiu jitsu atlanta"],
  openGraph: {
    title: "BJJ in Atlanta — Best Academies & Classes",
    description: "Find the best BJJ academies in Atlanta, GA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-atlanta",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-atlanta",
  },
};

export default async function BJJAtlantaPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Atlanta",
    description: "Brazilian jiu-jitsu schools and academies in Atlanta, GA",
    url: "https://aibjj.com/bjj-atlanta",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Atlanta", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Atlanta</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Atlanta, GA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Atlanta. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Atlanta</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Atlanta, GA.
