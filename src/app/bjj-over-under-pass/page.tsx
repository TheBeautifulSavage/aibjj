...
export const metadata: Metadata = {
  title: "Over-Under Pass: Classic Guard Pass | AIBJJ",
  description: "The over-under creates a chest-to-thigh pin that allows walking around the guard.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Over-Under Pass: Classic Guard Pass",
