...
export const metadata: Metadata = {
  title: "BJJ in San Francisco — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in San Francisco, CA. Compare ratings, read reviews, and start training BJJ today. Complete directory of San Francisco BJJ schools.",
  keywords: ["bjj san francisco", "brazilian jiu jitsu san francisco", "bjj classes san francisco", "bjj academies san francisco", "jiu jitsu san francisco"],
  openGraph: {
    title: "BJJ in San Francisco — Best Academies & Classes",
    description: "Find the best BJJ academies in San Francisco, CA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-san-francisco",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-san-francisco",
  },
};

export default async function BJJSanFranciscoPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in San Francisco",
    description: "Brazilian jiu-jitsu schools and academies in San Francisco, CA",
    url: "https://aibjj.com/bjj-san-francisco",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in San Francisco</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in San Francisco, CA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for San Francisco. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in San Francisco</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in San Francisco, CA.
