...
export const metadata: Metadata = {
  ...
  description: "How to set up and finish the defense from half guard in BJJ. Step-by-step breakdown with key details and drilling tips.",
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-4 text-xl text-zinc-400">How to set up and finish the defense from half guard in BJJ. Step-by-step breakdown with key details and drilling tips.</p>

        <div className="mt-10 space-y-10 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Setting Up from Half Guard</h2>
            <p>The defense from half guard begins with establishing control of the position and identifying the openings that allow entry. Grips, body position, and timing are critical. The setup must be smooth enough that your opponent does not recognize the entry until it is too late to defend effectively. Drill the entry sequence separately before combining it with the finish — muscle memory for the setup is what makes this technique work under pressure.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Key Details and Mechanics</h2>
            <p>The most common error when attempting the defense from half guard is rushing the finish before the position is fully controlled. Alignment and angle directly affect mechanical advantage. Address your opponent's likely defenses before they materialize — have a follow-up ready. The small details that differentiate a finished defense from one that gets defended are usually found in hip position, grip location, and the timing of the finishing pressure.</p>
          </section>
          <section>
