...
export const metadata: Metadata = {
  title: "BJJ in Detroit — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Detroit, MI. Compare ratings, read reviews, and start training BJJ today. Complete directory of Detroit BJJ schools.",
  keywords: ["bjj detroit", "brazilian jiu jitsu detroit", "bjj classes detroit", "bjj academies detroit", "jiu jitsu detroit"],
  openGraph: {
    title: "BJJ in Detroit — Best Academies & Classes",
    description: "Find the best BJJ academies in Detroit, MI. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-detroit",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-detroit",
  },
};

export default async function BJJDetroitPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Detroit",
    description: "Brazilian jiu-jitsu schools and academies in Detroit, MI",
    url: "https://aibjj.com/bjj-detroit",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Detroit", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Detroit</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Detroit, MI.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Detroit. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Detroit</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Detroit, MI.
