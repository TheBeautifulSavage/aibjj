...
export const metadata: Metadata = {
  title: "Taking the Back in BJJ: Complete Guide | AIBJJ",
  description: "Learn every method for getting to back control — the highest value position in BJJ.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Taking the Back in BJJ: Complete Guide",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Taking the Back in BJJ: Complete Guide</h1>
        <p className="mt-4 text-xl text-zinc-400">Learn every method for getting to back control — the highest value position in BJJ.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding taking the back in bjj: complete guide starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
