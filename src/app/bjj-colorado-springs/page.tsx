...
export const metadata: Metadata = {
  title: "BJJ in Colorado Springs — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Colorado Springs, CO. Compare ratings, read reviews, and start training BJJ today. Complete directory of Colorado Springs BJJ schools.",
  keywords: ["bjj colorado springs", "brazilian jiu jitsu colorado springs", "bjj classes colorado springs", "bjj academies colorado springs", "jiu jitsu colorado springs"],
  openGraph: {
    title: "BJJ in Colorado Springs — Best Academies & Classes",
    description: "Find the best BJJ academies in Colorado Springs, CO. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-colorado-springs",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-colorado-springs",
  },
};

export default async function BJJColoradoSpringsPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Colorado Springs",
    description: "Brazilian jiu-jitsu schools and academies in Colorado Springs, CO",
    url: "https://aibjj.com/bjj-colorado-springs",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Colorado Springs", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Colorado Springs</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Colorado Springs, CO.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Colorado Springs. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Colorado Springs</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Colorado Springs, CO.
