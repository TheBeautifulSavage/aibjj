...
export const metadata: Metadata = {
  title: "BJJ for MMA: Adapting Jiu-Jitsu for Fights | AIBJJ",
  description: "MMA BJJ focuses on ground control, submission defense, and finishing.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "BJJ for MMA: Adapting Jiu-Jitsu for Fights",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">BJJ for MMA: Adapting Jiu-Jitsu for Fights</h1>
        <p className="mt-4 text-xl text-zinc-400">MMA BJJ focuses on ground control, submission defense, and finishing.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding bjj for mma: adapting jiu-jitsu for fights starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
