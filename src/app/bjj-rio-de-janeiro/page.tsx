...
export const metadata: Metadata = {
  title: "BJJ in Rio de Janeiro, BR — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Rio de Janeiro, BR. Compare ratings, read reviews, and start training BJJ today. Complete directory of Rio de Janeiro BJJ schools.",
  keywords: ["bjj rio de janeiro", "brazilian jiu jitsu rio de janeiro", "bjj classes rio de janeiro", "bjj academies rio de janeiro", "jiu jitsu rio de janeiro"],
  openGraph: {
    title: "BJJ in Rio de Janeiro, BR — Best Academies & Classes",
    description: "Find the best BJJ academies in Rio de Janeiro, BR. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-rio-de-janeiro",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-rio-de-janeiro",
  },
};

export default async function BJJRiodeJaneiroPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Rio de Janeiro",
    description: "Brazilian jiu-jitsu schools and academies in Rio de Janeiro, BR",
    url: "https://aibjj.com/bjj-rio-de-janeiro",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Rio de Janeiro, BR</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Rio de Janeiro, BR.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Rio de Janeiro. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Rio de Janeiro</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Rio de Janeiro, BR.
