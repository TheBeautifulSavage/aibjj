...
export const metadata: Metadata = {
  ...
  description: "How to set up and finish the triangle choke from x-guard in BJJ. Step-by-step breakdown with key details and drilling tips.",
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-4 text-xl text-zinc-400">How to set up and finish the triangle choke from x-guard in BJJ. Step-by-step breakdown with key details and drilling tips.</p>
