...
export const metadata: Metadata = {
  title: "Cross Collar Choke: Classic Guard Attack | AIBJJ",
  description: "The cross collar choke uses both collar grips to create a blood choke from guard.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Cross Collar Choke: Classic Guard Attack",
