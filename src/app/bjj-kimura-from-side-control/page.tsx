...
export const metadata: Metadata = {
  title: "BJJ Kimura from Side Control | AIBJJ",
  description: "How to set up and finish the kimura from side control in BJJ. Step-by-step breakdown with key details and drilling tips.",
};
