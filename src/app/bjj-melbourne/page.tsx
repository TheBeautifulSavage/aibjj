...
export const metadata: Metadata = {
  title: "BJJ in Melbourne, AU — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Melbourne, AU. Compare ratings, read reviews, and start training BJJ today. Complete directory of Melbourne BJJ schools.",
  keywords: ["bjj melbourne", "brazilian jiu jitsu melbourne", "bjj classes melbourne", "bjj academies melbourne", "jiu jitsu melbourne"],
  openGraph: {
    title: "BJJ in Melbourne, AU — Best Academies & Classes",
    description: "Find the best BJJ academies in Melbourne, AU. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-melbourne",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-melbourne",
  },
};

export default async function BJJMelbournePage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Melbourne%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Melbourne",
    description: "Brazilian jiu-jitsu schools and academies in Melbourne, AU",
    url: "https://aibjj.com/bjj-melbourne",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Melbourne, AU</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Melbourne, AU.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Melbourne. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Melbourne</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Melbourne, AU.
