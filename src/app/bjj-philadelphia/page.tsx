...
export const metadata: Metadata = {
  title: "BJJ in Philadelphia — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Philadelphia, PA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Philadelphia BJJ schools.",
  keywords: ["bjj philadelphia", "brazilian jiu jitsu philadelphia", "bjj classes philadelphia", "bjj academies philadelphia", "jiu jitsu philadelphia"],
  openGraph: {
    title: "BJJ in Philadelphia — Best Academies & Classes",
    description: "Find the best BJJ academies in Philadelphia, PA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-philadelphia",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-philadelphia",
  },
};

export default async function BJJPhiladelphiaPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Philadelphia",
    description: "Brazilian jiu-jitsu schools and academies in Philadelphia, PA",
    url: "https://aibjj.com/bjj-philadelphia",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Philadelphia", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Philadelphia</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Philadelphia, PA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Philadelphia. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Philadelphia</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Philadelphia, PA.
