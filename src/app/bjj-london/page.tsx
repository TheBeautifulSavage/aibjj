...
export const metadata: Metadata = {
  title: "BJJ in London, UK — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in London, UK. Compare ratings, read reviews, and start training BJJ today. Complete directory of London BJJ schools.",
  keywords: ["bjj london", "brazilian jiu jitsu london", "bjj classes london", "bjj academies london", "jiu jitsu london"],
  openGraph: {
    title: "BJJ in London, UK — Best Academies & Classes",
    description: "Find the best BJJ academies in London, UK. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-london",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-london",
  },
};

export default async function BJJLondonPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in London",
    description: "Brazilian jiu-jitsu schools and academies in London, UK",
    url: "https://aibjj.com/bjj-london",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in London, UK</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in London, UK.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for London. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in London</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in London, UK.
