...
export const metadata: Metadata = {
  title: "Lapel Guard: Gi Gripping System | AIBJJ",
  description: "Lapel guard uses the gi to create unique control and submission threats.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Lapel Guard: Gi Gripping System",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Lapel Guard: Gi Gripping System</h1>
        <p className="mt-4 text-xl text-zinc-400">Lapel guard uses the gi to create unique control and submission threats.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding lapel guard: gi gripping system starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
