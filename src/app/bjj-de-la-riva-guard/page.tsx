...
export const metadata: Metadata = {
  title: "De La Riva Guard: Hook and Attack | AIBJJ",
  description: "De La Riva guard hooks the outside leg to control and sweep standing opponents.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "De La Riva Guard: Hook and Attack",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">De La Riva Guard: Hook and Attack</h1>
        <p className="mt-4 text-xl text-zinc-400">De La Riva guard hooks the outside leg to control and sweep standing opponents.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding de la riva guard: hook and attack starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
