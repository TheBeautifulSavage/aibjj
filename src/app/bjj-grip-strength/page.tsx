...
export const metadata: Metadata = {
  title: "Grip Strength for BJJ: Training Your Hands | AIBJJ",
  description: "Grip strength determines who controls the connection — train it specifically.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Grip Strength for BJJ: Training Your Hands",
