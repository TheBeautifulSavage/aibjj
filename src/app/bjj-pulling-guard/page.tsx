...
export const metadata: Metadata = {
  title: "Pulling Guard in BJJ: Strategy and Execution | AIBJJ",
  description: "Guard pulling is a legitimate competitive strategy — learn when and how to do it.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Pulling Guard in BJJ: Strategy and Execution",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Pulling Guard in BJJ: Strategy and Execution</h1>
        <p className="mt-4 text-xl text-zinc-400">Guard pulling is a legitimate competitive strategy — learn when and how to do it.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding pulling guard in bjj: strategy and execution starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
