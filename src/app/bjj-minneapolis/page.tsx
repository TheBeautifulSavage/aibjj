...
export const metadata: Metadata = {
  title: "BJJ in Minneapolis — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Minneapolis, MN. Compare ratings, read reviews, and start training BJJ today. Complete directory of Minneapolis BJJ schools.",
  keywords: ["bjj minneapolis", "brazilian jiu jitsu minneapolis", "bjj classes minneapolis", "bjj academies minneapolis", "jiu jitsu minneapolis"],
  openGraph: {
    title: "BJJ in Minneapolis — Best Academies & Classes",
    description: "Find the best BJJ academies in Minneapolis, MN. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-minneapolis",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-minneapolis",
  },
};

export default async function BJJMinneapolisPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Minneapolis%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Minneapolis",
    description: "Brazilian jiu-jitsu schools and academies in Minneapolis, MN",
    url: "https://aibjj.com/bjj-minneapolis",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Minneapolis", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Minneapolis</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Minneapolis, MN.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Minneapolis. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Minneapolis</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Minneapolis, MN.
