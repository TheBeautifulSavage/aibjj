...
export const metadata: Metadata = {
  title: "BJJ in El Paso — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in El Paso, TX. Compare ratings, read reviews, and start training BJJ today. Complete directory of El Paso BJJ schools.",
  keywords: ["bjj el paso", "brazilian jiu jitsu el paso", "bjj classes el paso", "bjj academies el paso", "jiu jitsu el paso"],
  openGraph: {
    title: "BJJ in El Paso — Best Academies & Classes",
    description: "Find the best BJJ academies in El Paso, TX. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-el-paso",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-el-paso",
  },
};

export default async function BJJElPasoPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in El Paso",
    description: "Brazilian jiu-jitsu schools and academies in El Paso, TX",
    url: "https://aibjj.com/bjj-el-paso",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "El Paso", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in El Paso</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in El Paso, TX.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for El Paso. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in El Paso</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in El Paso, TX.
