...
export const metadata: Metadata = {
  title: "BJJ in Fort Worth — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Fort Worth, TX. Compare ratings, read reviews, and start training BJJ today. Complete directory of Fort Worth BJJ schools.",
  keywords: ["bjj fort worth", "brazilian jiu jitsu fort worth", "bjj classes fort worth", "bjj academies fort worth", "jiu jitsu fort worth"],
  openGraph: {
    title: "BJJ in Fort Worth — Best Academies & Classes",
    description: "Find the best BJJ academies in Fort Worth, TX. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-fort-worth",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-fort-worth",
  },
};

export default async function BJJFortWorthPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Fort Worth%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Fort Worth",
    description: "Brazilian jiu-jitsu schools and academies in Fort Worth, TX",
    url: "https://aibjj.com/bjj-fort-worth",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Fort Worth", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Fort Worth</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Fort Worth, TX.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Fort Worth. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Fort Worth</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Fort Worth, TX.
