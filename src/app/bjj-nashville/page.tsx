...
export const metadata: Metadata = {
  title: "BJJ in Nashville — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Nashville, TN. Compare ratings, read reviews, and start training BJJ today. Complete directory of Nashville BJJ schools.",
  keywords: ["bjj nashville", "brazilian jiu jitsu nashville", "bjj classes nashville", "bjj academies nashville", "jiu jitsu nashville"],
  openGraph: {
    title: "BJJ in Nashville — Best Academies & Classes",
    description: "Find the best BJJ academies in Nashville, TN. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-nashville",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-nashville",
  },
};

export default async function BJJNashvillePage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Nashville",
    description: "Brazilian jiu-jitsu schools and academies in Nashville, TN",
    url: "https://aibjj.com/bjj-nashville",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Nashville", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Nashville</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Nashville, TN.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Nashville. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Nashville</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Nashville, TN.
