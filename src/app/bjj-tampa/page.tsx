...
export const metadata: Metadata = {
  title: "BJJ in Tampa — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Tampa, FL. Compare ratings, read reviews, and start training BJJ today. Complete directory of Tampa BJJ schools.",
  keywords: ["bjj tampa", "brazilian jiu jitsu tampa", "bjj classes tampa", "bjj academies tampa", "jiu jitsu tampa"],
  openGraph: {
    title: "BJJ in Tampa — Best Academies & Classes",
    description: "Find the best BJJ academies in Tampa, FL. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-tampa",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-tampa",
  },
};

export default async function BJJTampaPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Tampa",
    description: "Brazilian jiu-jitsu schools and academies in Tampa, FL",
    url: "https://aibjj.com/bjj-tampa",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Tampa", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Tampa</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Tampa, FL.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Tampa. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Tampa</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Tampa, FL.
