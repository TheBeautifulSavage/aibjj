...
export const metadata: Metadata = {
  title: "BJJ in Columbus — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Columbus, OH. Compare ratings, read reviews, and start training BJJ today. Complete directory of Columbus BJJ schools.",
  keywords: ["bjj columbus", "brazilian jiu jitsu columbus", "bjj classes columbus", "bjj academies columbus", "jiu jitsu columbus"],
  openGraph: {
    title: "BJJ in Columbus — Best Academies & Classes",
    description: "Find the best BJJ academies in Columbus, OH. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-columbus",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-columbus",
  },
};

export default async function BJJColumbusPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Columbus",
    description: "Brazilian jiu-jitsu schools and academies in Columbus, OH",
    url: "https://aibjj.com/bjj-columbus",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Columbus", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Columbus</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Columbus, OH.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Columbus. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Columbus</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Columbus, OH.
