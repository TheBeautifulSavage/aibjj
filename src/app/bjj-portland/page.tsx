...
export const metadata: Metadata = {
  title: "BJJ in Portland — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Portland, OR. Compare ratings, read reviews, and start training BJJ today. Complete directory of Portland BJJ schools.",
  keywords: ["bjj portland", "brazilian jiu jitsu portland", "bjj classes portland", "bjj academies portland", "jiu jitsu portland"],
  openGraph: {
    title: "BJJ in Portland — Best Academies & Classes",
    description: "Find the best BJJ academies in Portland, OR. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-portland",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-portland",
  },
};

export default async function BJJPortlandPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Portland",
    description: "Brazilian jiu-jitsu schools and academies in Portland, OR",
    url: "https://aibjj.com/bjj-portland",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Portland</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Portland, OR.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Portland. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Portland</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Portland, OR.
