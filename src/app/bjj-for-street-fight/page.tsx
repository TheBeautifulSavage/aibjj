...
export const metadata: Metadata = {
  title: "BJJ for Self-Defense: Street Fighting Reality | AIBJJ",
  description: "BJJ is highly effective for self-defense due to its focus on ground control.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "BJJ for Self-Defense: Street Fighting Reality",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">BJJ for Self-Defense: Street Fighting Reality</h1>
        <p className="mt-4 text-xl text-zinc-400">BJJ is highly effective for self-defense due to its focus on ground control.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding bjj for self-defense: street fighting reality starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
