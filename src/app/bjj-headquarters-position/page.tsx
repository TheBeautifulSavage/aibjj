...
export const metadata: Metadata = {
  title: "Headquarters Position: Passing Hub | AIBJJ",
  description: "Headquarters is the primary no-gi passing position for addressing open guard.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Headquarters Position: Passing Hub",
