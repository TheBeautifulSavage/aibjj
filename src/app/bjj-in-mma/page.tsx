...
export const metadata: Metadata = {
  title: "BJJ in MMA: How Jiu-Jitsu Works in Fights | AIBJJ",
  description: "BJJ gives MMA fighters the ability to fight on the ground and finish with submissions.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "BJJ in MMA: How Jiu-Jitsu Works in Fights",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">BJJ in MMA: How Jiu-Jitsu Works in Fights</h1>
        <p className="mt-4 text-xl text-zinc-400">BJJ gives MMA fighters the ability to fight on the ground and finish with submissions.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding bjj in mma: how jiu-jitsu works in fights starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
