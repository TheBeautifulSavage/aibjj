...
export const metadata: Metadata = {
  title: "BJJ in Anchorage — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Anchorage, AK. Compare ratings, read reviews, and start training BJJ today. Complete directory of Anchorage BJJ schools.",
  keywords: ["bjj anchorage", "brazilian jiu jitsu anchorage", "bjj classes anchorage", "bjj academies anchorage", "jiu jitsu anchorage"],
  openGraph: {
    title: "BJJ in Anchorage — Best Academies & Classes",
    description: "Find the best BJJ academies in Anchorage, AK. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-anchorage",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-anchorage",
  },
};

export default async function BJJAnchoragePage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Anchorage%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Anchorage",
    description: "Brazilian jiu-jitsu schools and academies in Anchorage, AK",
    url: "https://aibjj.com/bjj-anchorage",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Anchorage", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Anchorage</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Anchorage, AK.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Anchorage. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Anchorage</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Anchorage, AK.
