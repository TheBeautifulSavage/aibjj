...
export const metadata: Metadata = {
  title: "BJJ in Washington DC — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Washington DC, DC. Compare ratings, read reviews, and start training BJJ today. Complete directory of Washington DC BJJ schools.",
  keywords: ["bjj washington dc", "brazilian jiu jitsu washington dc", "bjj classes washington dc", "bjj academies washington dc", "jiu jitsu washington dc"],
  openGraph: {
    title: "BJJ in Washington DC — Best Academies & Classes",
    description: "Find the best BJJ academies in Washington DC, DC. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-washington-dc",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-washington-dc",
  },
};

export default async function BJJWashingtonDCPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Washington DC%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Washington DC",
    description: "Brazilian jiu-jitsu schools and academies in Washington DC, DC",
    url: "https://aibjj.com/bjj-washington-dc",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Washington DC", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Washington DC</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Washington DC, DC.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Washington DC. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Washington DC</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Washington DC, DC.
