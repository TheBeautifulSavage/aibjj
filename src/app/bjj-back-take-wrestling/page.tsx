...
export const metadata: Metadata = {
  title: "Wrestling-Based Back Takes in BJJ | AIBJJ",
  description: "Using wrestling setups like the duck under and body lock to take the back in BJJ.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Wrestling-Based Back Takes in BJJ",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Wrestling-Based Back Takes in BJJ</h1>
        <p className="mt-4 text-xl text-zinc-400">Using wrestling setups like the duck under and body lock to take the back in BJJ.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding wrestling-based back takes in bjj starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
