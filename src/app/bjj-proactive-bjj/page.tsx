...
export const metadata: Metadata = {
  title: "Proactive BJJ: Setting the Pace | AIBJJ",
  description: "Proactive BJJ creates problems that force opponents to react on your terms.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Proactive BJJ: Setting the Pace",
