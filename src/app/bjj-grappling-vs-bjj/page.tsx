...
export const metadata: Metadata = {
  title: "Grappling vs BJJ: What's the Difference? | AIBJJ",
  description: "Grappling is the broader category — BJJ is a specific grappling art with rules.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Grappling vs BJJ: What's the Difference?",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Grappling vs BJJ: What's the Difference?</h1>
        <p className="mt-4 text-xl text-zinc-400">Grappling is the broader category — BJJ is a specific grappling art with rules.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding grappling vs bjj: what's the difference? starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
