...
export const metadata: Metadata = {
  title: "BJJ in Orlando — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Orlando, FL. Compare ratings, read reviews, and start training BJJ today. Complete directory of Orlando BJJ schools.",
  keywords: ["bjj orlando", "brazilian jiu jitsu orlando", "bjj classes orlando", "bjj academies orlando", "jiu jitsu orlando"],
  openGraph: {
    title: "BJJ in Orlando — Best Academies & Classes",
    description: "Find the best BJJ academies in Orlando, FL. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-orlando",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-orlando",
  },
};

export default async function BJJOrlandoPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Orlando",
    description: "Brazilian jiu-jitsu schools and academies in Orlando, FL",
    url: "https://aibjj.com/bjj-orlando",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Orlando", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Orlando</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Orlando, FL.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Orlando. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Orlando</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Orlando, FL.
