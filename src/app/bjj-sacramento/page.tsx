...
export const metadata: Metadata = {
  title: "BJJ in Sacramento — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Sacramento, CA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Sacramento BJJ schools.",
  keywords: ["bjj sacramento", "brazilian jiu jitsu sacramento", "bjj classes sacramento", "bjj academies sacramento", "jiu jitsu sacramento"],
  openGraph: {
    title: "BJJ in Sacramento — Best Academies & Classes",
    description: "Find the best BJJ academies in Sacramento, CA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-sacramento",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-sacramento",
  },
};

export default async function BJJSacramentoPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Sacramento%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Sacramento",
    description: "Brazilian jiu-jitsu schools and academies in Sacramento, CA",
    url: "https://aibjj.com/bjj-sacramento",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Sacramento", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Sacramento</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Sacramento, CA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Sacramento. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Sacramento</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Sacramento, CA.
