...
export const metadata: Metadata = {
  title: "Single Leg Takedown: BJJ Entry | AIBJJ",
  description: "The single leg is versatile from clinch, level change, or failed double leg.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Single Leg Takedown: BJJ Entry",
