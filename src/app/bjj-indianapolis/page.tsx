...
export const metadata: Metadata = {
  title: "BJJ in Indianapolis — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Indianapolis, IN. Compare ratings, read reviews, and start training BJJ today. Complete directory of Indianapolis BJJ schools.",
  keywords: ["bjj indianapolis", "brazilian jiu jitsu indianapolis", "bjj classes indianapolis", "bjj academies indianapolis", "jiu jitsu indianapolis"],
  openGraph: {
    title: "BJJ in Indianapolis — Best Academies & Classes",
    description: "Find the best BJJ academies in Indianapolis, IN. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-indianapolis",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-indianapolis",
  },
};

export default async function BJJIndianapolisPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Indianapolis",
    description: "Brazilian jiu-jitsu schools and academies in Indianapolis, IN",
    url: "https://aibjj.com/bjj-indianapolis",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Indianapolis", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Indianapolis</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Indianapolis, IN.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Indianapolis. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Indianapolis</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Indianapolis, IN.
