...
export const metadata: Metadata = {
  title: "BJJ in San Jose — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in San Jose, CA. Compare ratings, read reviews, and start training BJJ today. Complete directory of San Jose BJJ schools.",
  keywords: ["bjj san jose", "brazilian jiu jitsu san jose", "bjj classes san jose", "bjj academies san jose", "jiu jitsu san jose"],
  openGraph: {
    title: "BJJ in San Jose — Best Academies & Classes",
    description: "Find the best BJJ academies in San Jose, CA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-san-jose",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-san-jose",
  },
};

export default async function BJJSanJosePage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in San Jose",
    description: "Brazilian jiu-jitsu schools and academies in San Jose, CA",
    url: "https://aibjj.com/bjj-san-jose",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "San Jose", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in San Jose</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in San Jose, CA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for San Jose. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in San Jose</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in San Jose, CA.
