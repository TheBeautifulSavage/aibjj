...
export const metadata: Metadata = {
  title: "BJJ in São Paulo, BR — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in São Paulo, BR. Compare ratings, read reviews, and start training BJJ today. Complete directory of São Paulo BJJ schools.",
  keywords: ["bjj sao paulo", "brazilian jiu jitsu sao paulo", "bjj classes sao paulo", "bjj academies sao paulo", "jiu jitsu sao paulo"],
  openGraph: {
    title: "BJJ in São Paulo, BR — Best Academies & Classes",
    description: "Find the best BJJ academies in São Paulo, BR. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-sao-paulo",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-sao-paulo",
  },
};

export default async function BJJSãoPauloPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in São Paulo",
    description: "Brazilian jiu-jitsu schools and academies in São Paulo, BR",
    url: "https://aibjj.com/bjj-sao-paulo",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in São Paulo, BR</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in São Paulo, BR.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for São Paulo. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in São Paulo</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in São Paulo, BR.
