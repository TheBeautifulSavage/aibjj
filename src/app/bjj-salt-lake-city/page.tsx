...
export const metadata: Metadata = {
  title: "BJJ in Salt Lake City — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Salt Lake City, UT. Compare ratings, read reviews, and start training BJJ today. Complete directory of Salt Lake City BJJ schools.",
  keywords: ["bjj salt lake city", "brazilian jiu jitsu salt lake city", "bjj classes salt lake city", "bjj academies salt lake city", "jiu jitsu salt lake city"],
  openGraph: {
    title: "BJJ in Salt Lake City — Best Academies & Classes",
    description: "Find the best BJJ academies in Salt Lake City, UT. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-salt-lake-city",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-salt-lake-city",
  },
};

export default async function BJJSaltLakeCityPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Salt Lake City%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Salt Lake City",
    description: "Brazilian jiu-jitsu schools and academies in Salt Lake City, UT",
    url: "https://aibjj.com/bjj-salt-lake-city",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Salt Lake City", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Salt Lake City</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Salt Lake City, UT.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Salt Lake City. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Salt Lake City</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Salt Lake City, UT.
