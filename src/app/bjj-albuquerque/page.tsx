...
export const metadata: Metadata = {
  title: "BJJ in Albuquerque — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Albuquerque, NM. Compare ratings, read reviews, and start training BJJ today. Complete directory of Albuquerque BJJ schools.",
  keywords: ["bjj albuquerque", "brazilian jiu jitsu albuquerque", "bjj classes albuquerque", "bjj academies albuquerque", "jiu jitsu albuquerque"],
  openGraph: {
    title: "BJJ in Albuquerque — Best Academies & Classes",
    description: "Find the best BJJ academies in Albuquerque, NM. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-albuquerque",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-albuquerque",
  },
};

export default async function BJJAlbuquerquePage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Albuquerque%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Albuquerque",
    description: "Brazilian jiu-jitsu schools and academies in Albuquerque, NM",
    url: "https://aibjj.com/bjj-albuquerque",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Albuquerque", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Albuquerque</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Albuquerque, NM.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Albuquerque. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Albuquerque</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Albuquerque, NM.
