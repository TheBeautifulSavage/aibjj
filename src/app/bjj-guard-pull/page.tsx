...
export const metadata: Metadata = {
  title: "Guard Pull: BJJ Strategy and Execution | AIBJJ",
  description: "Guard pulling is a deliberate choice to bring the fight to the ground on your terms.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Guard Pull: BJJ Strategy and Execution",
