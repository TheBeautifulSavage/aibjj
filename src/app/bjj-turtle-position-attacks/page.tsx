...
export const metadata: Metadata = {
  title: "Turtle Position Attacks: Top Game | AIBJJ",
  description: "Attacking the turtle with back takes, clock chokes, and leg hooks.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Turtle Position Attacks: Top Game",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Turtle Position Attacks: Top Game</h1>
        <p className="mt-4 text-xl text-zinc-400">Attacking the turtle with back takes, clock chokes, and leg hooks.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding turtle position attacks: top game starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
