...
export const metadata: Metadata = {
  title: "Arm-In Guillotine: The Most Dangerous Variation | AIBJJ",
  description: "The arm-in guillotine traps the arm and neck for a devastating choke.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Arm-In Guillotine: The Most Dangerous Variation",
