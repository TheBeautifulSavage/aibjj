...
export const metadata: Metadata = {
  title: "Flexibility for BJJ: Mobility Training | AIBJJ",
  description: "Mobility and flexibility improve guard retention, escapes, and submission defense.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Flexibility for BJJ: Mobility Training",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Flexibility for BJJ: Mobility Training</h1>
        <p className="mt-4 text-xl text-zinc-400">Mobility and flexibility improve guard retention, escapes, and submission defense.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding flexibility for bjj: mobility training starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
