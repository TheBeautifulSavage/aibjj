...
export const metadata: Metadata = {
  title: "Tilt Sweep: Open Guard Sweeping | AIBJJ",
  description: "The tilt sweep creates angular force to off-balance and sweep standing opponents.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Tilt Sweep: Open Guard Sweeping",
