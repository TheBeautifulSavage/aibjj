...
export const metadata: Metadata = {
  title: "BJJ in Raleigh — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Raleigh, NC. Compare ratings, read reviews, and start training BJJ today. Complete directory of Raleigh BJJ schools.",
  keywords: ["bjj raleigh", "brazilian jiu jitsu raleigh", "bjj classes raleigh", "bjj academies raleigh", "jiu jitsu raleigh"],
  openGraph: {
    title: "BJJ in Raleigh — Best Academies & Classes",
    description: "Find the best BJJ academies in Raleigh, NC. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-raleigh",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-raleigh",
  },
};

export default async function BJJRaleighPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Raleigh",
    description: "Brazilian jiu-jitsu schools and academies in Raleigh, NC",
    url: "https://aibjj.com/bjj-raleigh",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Raleigh", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Raleigh</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Raleigh, NC.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Raleigh. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Raleigh</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Raleigh, NC.
