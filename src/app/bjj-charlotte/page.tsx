...
export const metadata: Metadata = {
  title: "BJJ in Charlotte — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Charlotte, NC. Compare ratings, read reviews, and start training BJJ today. Complete directory of Charlotte BJJ schools.",
  keywords: ["bjj charlotte", "brazilian jiu jitsu charlotte", "bjj classes charlotte", "bjj academies charlotte", "jiu jitsu charlotte"],
  openGraph: {
    title: "BJJ in Charlotte — Best Academies & Classes",
    description: "Find the best BJJ academies in Charlotte, NC. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-charlotte",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-charlotte",
  },
};

export default async function BJJCharlottePage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Charlotte%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Charlotte",
    description: "Brazilian jiu-jitsu schools and academies in Charlotte, NC",
    url: "https://aibjj.com/bjj-charlotte",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Charlotte", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Charlotte</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Charlotte, NC.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Charlotte. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Charlotte</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Charlotte, NC.
