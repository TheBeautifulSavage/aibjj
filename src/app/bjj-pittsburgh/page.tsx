...
export const metadata: Metadata = {
  title: "BJJ in Pittsburgh — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Pittsburgh, PA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Pittsburgh BJJ schools.",
  keywords: ["bjj pittsburgh", "brazilian jiu jitsu pittsburgh", "bjj classes pittsburgh", "bjj academies pittsburgh", "jiu jitsu pittsburgh"],
  openGraph: {
    title: "BJJ in Pittsburgh — Best Academies & Classes",
    description: "Find the best BJJ academies in Pittsburgh, PA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-pittsburgh",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-pittsburgh",
  },
};

export default async function BJJPittsburghPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Pittsburgh",
    description: "Brazilian jiu-jitsu schools and academies in Pittsburgh, PA",
    url: "https://aibjj.com/bjj-pittsburgh",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Pittsburgh", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Pittsburgh</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Pittsburgh, PA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Pittsburgh. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Pittsburgh</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Pittsburgh, PA.
