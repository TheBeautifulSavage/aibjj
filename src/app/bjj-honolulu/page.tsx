...
export const metadata: Metadata = {
  title: "BJJ in Honolulu — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Honolulu, HI. Compare ratings, read reviews, and start training BJJ today. Complete directory of Honolulu BJJ schools.",
  keywords: ["bjj honolulu", "brazilian jiu jitsu honolulu", "bjj classes honolulu", "bjj academies honolulu", "jiu jitsu honolulu"],
  openGraph: {
    title: "BJJ in Honolulu — Best Academies & Classes",
    description: "Find the best BJJ academies in Honolulu, HI. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-honolulu",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-honolulu",
  },
};

export default async function BJJHonoluluPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Honolulu",
    description: "Brazilian jiu-jitsu schools and academies in Honolulu, HI",
    url: "https://aibjj.com/bjj-honolulu",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Honolulu", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Honolulu</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Honolulu, HI.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Honolulu. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Honolulu</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Honolulu, HI.
