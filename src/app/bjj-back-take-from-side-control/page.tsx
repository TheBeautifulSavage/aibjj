...
export const metadata: Metadata = {
  ...
  description: "How to set up and finish the back take from side control in BJJ. Step-by-step breakdown with key details and drilling tips.",
};
...
<article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-4 text-xl text-zinc-400">How to set up and finish the back take from side control in BJJ. Step-by-step breakdown with key details and drilling tips.</p>
