...
export const metadata: Metadata = {
  title: "Strength Training for BJJ: What Actually Works | AIBJJ",
  description: "The best strength program for BJJ builds functional strength without gassing out.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Strength Training for BJJ: What Actually Works",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Strength Training for BJJ: What Actually Works</h1>
        <p className="mt-4 text-xl text-zinc-400">The best strength program for BJJ builds functional strength without gassing out.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding strength training for bjj: what actually works starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
