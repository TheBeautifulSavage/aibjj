...
export const metadata: Metadata = {
  title: "The Gracie Family: BJJ Dynasty | AIBJJ",
  description: "The Gracies popularized and developed Brazilian jiu-jitsu into a global art.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "The Gracie Family: BJJ Dynasty",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">The Gracie Family: BJJ Dynasty</h1>
        <p className="mt-4 text-xl text-zinc-400">The Gracies popularized and developed Brazilian jiu-jitsu into a global art.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding the gracie family: bjj dynasty starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
