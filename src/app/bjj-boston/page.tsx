...
export const metadata: Metadata = {
  title: "BJJ in Boston — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Boston, MA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Boston BJJ schools.",
  keywords: ["bjj boston", "brazilian jiu jitsu boston", "bjj classes boston", "bjj academies boston", "jiu jitsu boston"],
  openGraph: {
    title: "BJJ in Boston — Best Academies & Classes",
    description: "Find the best BJJ academies in Boston, MA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-boston",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-boston",
  },
};

export default async function BJJBostonPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Boston",
    description: "Brazilian jiu-jitsu schools and academies in Boston, MA",
    url: "https://aibjj.com/bjj-boston",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Boston", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Boston</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Boston, MA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Boston. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Boston</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Boston, MA.
