...
export const metadata: Metadata = {
  title: "Flower Sweep: Overhead Guard Sweep | AIBJJ",
  description: "The flower sweep uses an overhook to take your opponent overhead from closed guard.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Flower Sweep: Overhead Guard Sweep",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Flower Sweep: Overhead Guard Sweep</h1>
        <p className="mt-4 text-xl text-zinc-400">The flower sweep uses an overhook to take your opponent overhead from closed guard.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding flower sweep: overhead guard sweep starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
