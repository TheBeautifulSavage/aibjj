...
export const metadata: Metadata = {
  title: "BJJ for Athletes: Cross-Training Benefits | AIBJJ",
  description: "Athletes from other sports use BJJ to improve body awareness and conditioning.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "BJJ for Athletes: Cross-Training Benefits",
