...
export const metadata: Metadata = {
  title: "BJJ in San Antonio — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in San Antonio, TX. Compare ratings, read reviews, and start training BJJ today. Complete directory of San Antonio BJJ schools.",
  keywords: ["bjj san antonio", "brazilian jiu jitsu san antonio", "bjj classes san antonio", "bjj academies san antonio", "jiu jitsu san antonio"],
  openGraph: {
    title: "BJJ in San Antonio — Best Academies & Classes",
    description: "Find the best BJJ academies in San Antonio, TX. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-san-antonio",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-san-antonio",
  },
};

export default async function BJJSanAntonioPage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%San Antonio%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in San Antonio",
    description: "Brazilian jiu-jitsu schools and academies in San Antonio, TX",
    url: "https://aibjj.com/bjj-san-antonio",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "San Antonio", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in San Antonio</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in San Antonio, TX.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for San Antonio. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in San Antonio</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in San Antonio, TX.
