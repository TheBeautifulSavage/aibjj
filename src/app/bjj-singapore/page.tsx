...
export const metadata: Metadata = {
  title: "BJJ in Singapore, SG — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Singapore, SG. Compare ratings, read reviews, and start training BJJ today. Complete directory of Singapore BJJ schools.",
  keywords: ["bjj singapore", "brazilian jiu jitsu singapore", "bjj classes singapore", "bjj academies singapore", "jiu jitsu singapore"],
  openGraph: {
    title: "BJJ in Singapore, SG — Best Academies & Classes",
    description: "Find the best BJJ academies in Singapore, SG. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-singapore",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-singapore",
  },
};

export default async function BJJSingaporePage() {
  const { data: academies } = await supabase
    .from("Academy")
    .select("id, name, slug, city, country, rating, review_count, address")
    .ilike("city", "%Singapore%")
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Singapore",
    description: "Brazilian jiu-jitsu schools and academies in Singapore, SG",
    url: "https://aibjj.com/bjj-singapore",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Singapore, SG</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Singapore, SG.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Singapore. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Singapore</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Singapore, SG.
