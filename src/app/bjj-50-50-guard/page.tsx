...
export const metadata: Metadata = {
  title: "50/50 Guard: Position and Attacks | AIBJJ",
  description: "The 50/50 guard is a neutral entanglement used primarily for leg lock exchanges.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "50/50 Guard: Position and Attacks",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">50/50 Guard: Position and Attacks</h1>
        <p className="mt-4 text-xl text-zinc-400">The 50/50 guard is a neutral entanglement used primarily for leg lock exchanges.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding 50/50 guard: position and attacks starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
