...
export const metadata: Metadata = {
  title: "BJJ in Dubai, AE — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Dubai, AE. Compare ratings, read reviews, and start training BJJ today. Complete directory of Dubai BJJ schools.",
  keywords: ["bjj dubai", "brazilian jiu jitsu dubai", "bjj classes dubai", "bjj academies dubai", "jiu jitsu dubai"],
  openGraph: {
    title: "BJJ in Dubai, AE — Best Academies & Classes",
    description: "Find the best BJJ academies in Dubai, AE. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-dubai",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-dubai",
  },
};

export default async function BJJDubaiPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Dubai",
    description: "Brazilian jiu-jitsu schools and academies in Dubai, AE",
    url: "https://aibjj.com/bjj-dubai",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Dubai, AE</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Dubai, AE.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Dubai. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Dubai</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Dubai, AE.
