...
export const metadata: Metadata = {
  title: "BJJ in San Diego — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in San Diego, CA. Compare ratings, read reviews, and start training BJJ today. Complete directory of San Diego BJJ schools.",
  keywords: ["bjj san diego", "brazilian jiu jitsu san diego", "bjj classes san diego", "bjj academies san diego", "jiu jitsu san diego"],
  openGraph: {
    title: "BJJ in San Diego — Best Academies & Classes",
    description: "Find the best BJJ academies in San Diego, CA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-san-diego",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-san-diego",
  },
};

export default async function BJJSanDiegoPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in San Diego",
    description: "Brazilian jiu-jitsu schools and academies in San Diego, CA",
    url: "https://aibjj.com/bjj-san-diego",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "San Diego", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in San Diego</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in San Diego, CA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for San Diego. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in San Diego</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in San Diego, CA.
