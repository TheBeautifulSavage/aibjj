...
export const metadata: Metadata = {
  title: "BJJ in Las Vegas — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Las Vegas, NV. Compare ratings, read reviews, and start training BJJ today. Complete directory of Las Vegas BJJ schools.",
  keywords: ["bjj las vegas", "brazilian jiu jitsu las vegas", "bjj classes las vegas", "bjj academies las vegas", "jiu jitsu las vegas"],
  openGraph: {
    title: "BJJ in Las Vegas — Best Academies & Classes",
    description: "Find the best BJJ academies in Las Vegas, NV. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-las-vegas",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-las-vegas",
  },
};

export default async function BJJLasVegasPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Las Vegas",
    description: "Brazilian jiu-jitsu schools and academies in Las Vegas, NV",
    url: "https://aibjj.com/bjj-las-vegas",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Las Vegas</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Las Vegas, NV.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Las Vegas. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Las Vegas</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Las Vegas, NV.
