...
export const metadata: Metadata = {
  title: "BJJ in Sydney, AU — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Sydney, AU. Compare ratings, read reviews, and start training BJJ today. Complete directory of Sydney BJJ schools.",
  keywords: ["bjj sydney", "brazilian jiu jitsu sydney", "bjj classes sydney", "bjj academies sydney", "jiu jitsu sydney"],
  openGraph: {
    title: "BJJ in Sydney, AU — Best Academies & Classes",
    description: "Find the best BJJ academies in Sydney, AU. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-sydney",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-sydney",
  },
};

export default async function BJJSydneyPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Sydney",
    description: "Brazilian jiu-jitsu schools and academies in Sydney, AU",
    url: "https://aibjj.com/bjj-sydney",
    numberOfItems: count,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Sydney, AU</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Sydney, AU.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Sydney. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Sydney</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Sydney, AU.
