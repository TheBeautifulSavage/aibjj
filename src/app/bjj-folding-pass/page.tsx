...
export const metadata: Metadata = {
  title: "Folding Pass: Stack Guard Pass | AIBJJ",
  description: "The folding pass stacks the opponent by folding their legs toward their face to pass.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Folding Pass: Stack Guard Pass",
