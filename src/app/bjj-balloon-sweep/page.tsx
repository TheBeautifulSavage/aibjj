...
export const metadata: Metadata = {
  title: "Balloon Sweep: Foot on Hip Guard Sweep | AIBJJ",
  description: "The balloon sweep uses foot on hip to create space and sweep opponents off-balance.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Balloon Sweep: Foot on Hip Guard Sweep",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Balloon Sweep: Foot on Hip Guard Sweep</h1>
        <p className="mt-4 text-xl text-zinc-400">The balloon sweep uses foot on hip to create space and sweep opponents off-balance.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding balloon sweep: foot on hip guard sweep starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
