...
export const metadata: Metadata = {
  title: "BJJ in Richmond — Best Brazilian Jiu-Jitsu Academies & Classes | AIBJJ",
  description: "Find the best Brazilian jiu-jitsu academies and classes in Richmond, VA. Compare ratings, read reviews, and start training BJJ today. Complete directory of Richmond BJJ schools.",
  keywords: ["bjj richmond", "brazilian jiu jitsu richmond", "bjj classes richmond", "bjj academies richmond", "jiu jitsu richmond"],
  openGraph: {
    title: "BJJ in Richmond — Best Academies & Classes",
    description: "Find the best BJJ academies in Richmond, VA. Ratings, reviews, and directions.",
    url: "https://aibjj.com/bjj-richmond",
  },
  alternates: {
    canonical: "https://aibjj.com/bjj-richmond",
  },
};

export default async function BJJRichmondPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    name: "BJJ Academies in Richmond",
    description: "Brazilian jiu-jitsu schools and academies in Richmond, VA",
    url: "https://aibjj.com/bjj-richmond",
    numberOfItems: count,
    itemListElement: (academies || []).slice(0, 10).map((a: any, i: number) => ({
      ...
      item: {
        ...
        address: { "@type": "PostalAddress", addressLocality: "Richmond", addressCountry: "US" },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-black mb-4">BJJ in Richmond</h1>
        <p className="text-xl text-zinc-400 mb-8">
          Find the best Brazilian jiu-jitsu academies and classes in Richmond, VA.
        ...
        {count > 0 ? (
          ...
          <p className="text-zinc-500 mb-12">No academies listed yet for Richmond. Know one? Let us know.</p>
        )}

        <div className="border-t border-zinc-800 pt-12">
          <h2 className="text-2xl font-bold mb-4">About BJJ in Richmond</h2>
          <p className="text-zinc-400 mb-6">
            Brazilian jiu-jitsu is one of the fastest growing martial arts in Richmond, VA.
