...
export const metadata: Metadata = {
  title: "Rolling Back Take: Momentum-Based Entry | AIBJJ",
  description: "The rolling back take uses momentum and a forward roll to transition to back mount.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Rolling Back Take: Momentum-Based Entry",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Rolling Back Take: Momentum-Based Entry</h1>
        <p className="mt-4 text-xl text-zinc-400">The rolling back take uses momentum and a forward roll to transition to back mount.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding rolling back take: momentum-based entry starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
