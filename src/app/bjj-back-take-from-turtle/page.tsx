...
export const metadata: Metadata = {
  title: "Back Take from Turtle Position | AIBJJ",
  description: "Attacking the turtle position is the primary way to get back control in top game BJJ.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Back Take from Turtle Position",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Back Take from Turtle Position</h1>
        <p className="mt-4 text-xl text-zinc-400">Attacking the turtle position is the primary way to get back control in top game BJJ.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding back take from turtle position starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
