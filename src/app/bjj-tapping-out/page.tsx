...
export const metadata: Metadata = {
  title: "Tapping Out in BJJ: The Importance of the Tap | AIBJJ",
  description: "Tapping is fundamental to BJJ training — it prevents injury and enables learning.",
};
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "Tapping Out in BJJ: The Importance of the Tap",
...
<article className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-black">Tapping Out in BJJ: The Importance of the Tap</h1>
        <p className="mt-4 text-xl text-zinc-400">Tapping is fundamental to BJJ training — it prevents injury and enables learning.</p>
        <div className="mt-10 space-y-8 text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">Fundamentals</h2>
            <p>Understanding tapping out in bjj: the importance of the tap starts with the basic mechanics and positional requirements. This technique fits within the broader BJJ system and connects to multiple positions and attacks. Proper execution requires correct body positioning, timing, and an understanding of how your opponent is likely to respond.</p>
          </section>
          <section>
